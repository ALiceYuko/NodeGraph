...
struct Style
{
    ...
    Style()
    {
		...
		Colors[StyleColor_ActiveNodeBorder]	  = ImColor(255, 50, 50, 200);
...
void NodeSetActive(bool bActive);
void EndNode();
